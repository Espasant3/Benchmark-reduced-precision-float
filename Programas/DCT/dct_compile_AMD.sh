...
gcc-14 -Wall -g dct_FP32.c -o dct_FP32
...
gcc-14 -Wall -g dct_FP16.c -o dct_FP16 -fexcess-precision=16
...
if grep -q "avx512fp16" /proc/cpuinfo; then
    ...
    gcc-14 -Wall -g dct_FP16.c -o dct_FP16_native-base -mavx512fp16
    # Compilar el programa optimizado con AVX512-FP16 y precisión estándar
    gcc-14 -Wall -g dct_FP16.c -o dct_FP16_avx512fp16_precision -fexcess-precision=standard -mavx512fp16
    # Compilar el programa con máxima optimización para AVX512-FP16
    gcc-14 -Wall -g dct_FP16.c -o dct_FP16_max_performance -fexcess-precision=standard -mfpmath=sse -mavx512fp16
    ...
    gcc-14 -Wall -g dct_FP16.c -o dct_FP16_native-base -mavx512f
    # Compilar el programa optimizado con AVX512 y precisión estándar
    gcc-14 -Wall -g dct_FP16.c -o dct_FP16_avx512_precision -fexcess-precision=standard -mavx512f
    # Compilar el programa con máxima optimización para AVX512
    gcc-14 -Wall -g dct_FP16.c -o dct_FP16_max_performance -fexcess-precision=standard -mfpmath=sse -mavx512f
