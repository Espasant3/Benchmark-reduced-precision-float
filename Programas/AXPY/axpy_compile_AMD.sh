...
OPT_FLAGS="-O3 -fomit-frame-pointer -fPIC"
...
if grep -q "sse2" /proc/cpuinfo; then
    ...
    if grep -q "avx512fp16" /proc/cpuinfo; then
        ...
        gcc-14 $COMMON_FLAGS axpy_FP16.c -o axpy_FP16_native-base -mavx512f
        # Compilar el programa optimizado con AVX512 y precisión estándar
        gcc-14 $COMMON_FLAGS axpy_FP16.c -o axpy_FP16_avx512_precision -fexcess-precision=16 -mavx512f
        # Compilar el programa con máxima optimización para AVX512
        gcc-14 $COMMON_FLAGS axpy_FP16.c -o axpy_FP16_max_performance -fexcess-precision=16 -mfpmath=sse -mavx512f
